...
class AppController extends ChangeNotifier with WidgetsBindingObserver {
  ...
  Future<void> connect() async {
    await disconnect(clearUiState: false, manual: false);
...
''';
  ...
  Future<void> _startTurn(
    ...
    final input = _buildUserInput(prompt, attachments);
    final optimisticEntryKey = _addOptimisticUserEntry(prompt, attachments);
    ...
    try {
      ...
      final response = await _request(
        ...
        <String, dynamic>{
          ...
          'input': _buildUserInput(prompt, attachments),
        },
        containsImageAttachment
            ? const Duration(minutes: 5)
            : const Duration(seconds: 20),
  ...
  List<Map<String, dynamic>> _buildUserInput(
    String prompt,
    List<ComposerAttachment> attachments,
  ) {
    ...
    for (final attachment in imageAttachments) {
      ...
      input.add(<String, dynamic>{'type': 'image', 'url': dataUrl});
    }
    return input;
  }
  ...
  Future<Map<String, dynamic>?> _request(
    ...
    _send(<String, dynamic>{'id': id, 'method': method, ...paramsField});
  ...
  void _notify(String method, [Map<String, dynamic>? params]) {
    ...
    _send(<String, dynamic>{'method': method, ...?paramsField});
  }

  void _send(Map<String, dynamic> payload) {
    unawaited(_transport.send(jsonEncode(payload)));
  }
